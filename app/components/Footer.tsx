...
const Footer = () => (
  <footer className="border-t bg-background">
    <div className="container px-4 max-w-7xl mx-auto flex flex-col gap-6 py-8">
      <div
      ...
      >
        ...
        <div
          className="flex-1 w-full flex flex-col items-center md:items-start pt-6 md:pt-0"
          id="r1c2"
        >
      ...
      <div className="border-t py-6" id="r2">
        <div className="container flex flex-col items-center justify-between gap-4 md:flex-row">
          <p className="text-center text-sm text-muted-foreground md:text-left">
            <Link href="/dashboard/admin">&copy;</Link>{" "}
            {new Date().getFullYear()} ParkSuite. All rights reserved.
          </p>
        </div>
      </div>
    </div>
